...
{
    [TestFixture]
    public class ImageCaptureInitializesEventArgsTests
    {
        [Test]
        public void OutputMenu_property_is_not_altered()
        {
            MenuItem outputMenu = new MenuItem();

            ImageCaptureInitializedEventArgs args = new ImageCaptureInitializedEventArgs(null);
            args.OutputMenu = outputMenu;

            Assert.AreEqual(outputMenu, args.OutputMenu);
        }
        ...
        public void Constructor_parameters_are_not_altered()
        {
            ...
            ImageCaptureInitializedEventArgs pair = new ImageCaptureInitializedEventArgs(outputMenu);

            Assert.AreEqual(outputMenu, pair.OutputMenu);
        }
    }
}