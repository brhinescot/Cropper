...
// ReSharper disable UnusedMember.Global
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Windows.Forms.ListViewGroupCollection" /> that contains all the groups in the
        ///     <see cref="T:System.Windows.Forms.ListView" /> control.
        /// </returns>
        /// <filterpriority>2</filterpriority>
        public ListViewGroupCollection Groups => shortcutList.Groups;

        /// <summary>
        ///     Gets or sets a value indicating whether the selected item in the control remains highlighted when the control loses
        ///     focus.
        /// </summary>
        /// <returns>
        ///     true if the selected item does not appear highlighted when the control loses focus; false if the selected item
        ///     still appears highlighted when the control loses focus. The default is true.
        /// </returns>
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether a scroll bar is added to the control when there is not enough room to
        ///     display all items.
        /// </summary>
        /// <returns>
        ///     true if scroll bars are added to the control when necessary to allow the user to see all the items; otherwise,
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Windows.Forms.ListView.SelectedListViewItemCollection"></see> that contains the items that
        ///     are selected in the control. If no items are currently selected, an empty
        ///     <see cref="T:System.Windows.Forms.ListView.SelectedListViewItemCollection"></see> is returned.
        /// </returns>
        /// <filterpriority>1</filterpriority>
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Windows.Forms.ListView.SelectedIndexCollection"></see> that contains the indexes of the
        ///     selected items. If no items are currently selected, an empty
        ///     <see cref="T:System.Windows.Forms.ListView.SelectedIndexCollection"></see> is returned.
        /// </returns>
        /// <filterpriority>1</filterpriority>
        public ListView.SelectedIndexCollection SelectedIndices => shortcutList.SelectedIndices;

        /// <summary>
        ///     Gets or sets the <see cref="T:System.Windows.Forms.ImageList"></see> to use when displaying items as small icons in
        ///     the control.
        /// </summary>
        /// <returns>
        ///     An <see cref="T:System.Windows.Forms.ImageList"></see> that contains the icons to use when the
        ///     <see cref="P:System.Windows.Forms.ListView.View"></see> property is set to
        ///     <see cref="F:System.Windows.Forms.View.SmallIcon"></see>. The default is null.
        /// </returns>
        /// <filterpriority>2</filterpriority>
        /// <PermissionSet>
        ///     <IPermission
        ...
        ///     <see cref="T:System.Windows.Forms.ListViewItem"></see> objects contained in the
        ///     <see cref="T:System.Windows.Forms.ListView"></see>.
        /// </summary>
        /// <returns>
        ///     true if <see cref="T:System.Windows.Forms.ListViewItem"></see> ToolTips should be shown; otherwise, false. The
        ///     default is true.
        /// </returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ...
        ///     The <see cref="P:System.Windows.Forms.ListView.View"></see>
        ///     property is set to <see cref="F:System.Windows.Forms.View.LargeIcon"></see>,
        ///     <see cref="F:System.Windows.Forms.View.SmallIcon"></see>, or <see cref="F:System.Windows.Forms.View.Tile"></see>.
        /// </exception>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///     <IPermission
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Windows.Forms.ListView.ColumnHeaderCollection"></see> that represents the column headers that
        ///     appear when the <see cref="P:System.Windows.Forms.ListView.View"></see> property is set to
        ///     <see cref="F:System.Windows.Forms.View.Details"></see>.
        /// </returns>
        /// <filterpriority>1</filterpriority>
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Windows.Forms.ListViewItem"></see> that represents the item that has focus, or null if no
        ///     item has the focus in the <see cref="T:System.Windows.Forms.ListView"></see>.
        /// </returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///     <IPermission
        ...
        /// </summary>
        /// <returns>
        ///     true if clicking an item selects the item and all its subitems; false if clicking an item selects only the item
        ///     itself. The default is false.
        /// </returns>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///     <IPermission
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether grid lines appear between the rows and columns containing the items and
        ///     subitems in the control.
        /// </summary>
        /// <returns>
        ...
        /// </summary>
        /// <returns>
        ///     One of the <see cref="T:System.Windows.Forms.ColumnHeaderStyle"></see> values. The default is
        ///     <see cref="F:System.Windows.Forms.ColumnHeaderStyle.Clickable"></see>.
        /// </returns>
        /// <exception cref="T:System.ComponentModel.InvalidEnumArgumentException">
        ///     The value specified is not one of the
        ///     <see cref="T:System.Windows.Forms.ColumnHeaderStyle"></see> values.
        /// </exception>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///     <IPermission
        ...
        /// <summary>
        ///     Finds the first <see cref="T:System.Windows.Forms.ListViewItem"></see> or
        ///     <see cref="T:System.Windows.Forms.ListViewItem.ListViewSubItem"></see>, if indicated, that begins with the
        ...
        /// <param name="text">The text to search for.</param>
        /// <exception cref="T:System.ArgumentOutOfRangeException">
        ///     <paramref name="startIndex" /> is less 0 or more than the number
        ///     of items in the <see cref="T:System.Windows.Forms.ListView"></see>.
        /// </exception>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ///     <IPermission
        ...
        /// </summary>
        /// <returns>
        ///     The <see cref="T:System.Windows.Forms.ListViewItem"></see> that is closest to the given point, searching in the
        ///     specified direction.
        /// </returns>
        ...
        /// <exception cref="T:System.InvalidOperationException">
        ///     <see cref="P:System.Windows.Forms.ListView.View"></see> is set to
        ///     a value other than <see cref="F:System.Windows.Forms.View.SmallIcon"></see> or
        ///     <see cref="F:System.Windows.Forms.View.LargeIcon"></see>.
        /// </exception>
        ...
        /// </summary>
        /// <returns>
        ///     The <see cref="T:System.Windows.Forms.ListViewItem"></see> that is closest to the given coordinates, searching in
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Windows.Forms.ListViewItem"></see> that represents the item at the specified position. If
        ///     there is no item at the specified location, the method returns null.
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Drawing.Rectangle"></see> that represents the bounding rectangle of the specified
        ///     <see cref="T:System.Windows.Forms.ListViewItem"></see>.
        /// </returns>
        /// <param name="index">
        ///     The zero-based index of the item within the
        ///     <see cref="T:System.Windows.Forms.ListView.ListViewItemCollection"></see> whose bounding rectangle you want to
        ///     return.
        /// </param>
        /// <filterpriority>1</filterpriority>
        /// <PermissionSet>
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="T:System.Drawing.Rectangle"></see> that represents the bounding rectangle for the specified portion of
        ///     the specified <see cref="T:System.Windows.Forms.ListViewItem"></see>.
        /// </returns>
        /// <param name="portion">
        ///     One of the <see cref="T:System.Windows.Forms.ItemBoundsPortion"></see> values that represents a
        ///     portion of the <see cref="T:System.Windows.Forms.ListViewItem"></see> for which to retrieve the bounding rectangle.
        /// </param>
        /// <param name="index">
        ///     The zero-based index of the item within the
        ///     <see cref="T:System.Windows.Forms.ListView.ListViewItemCollection"></see> whose bounding rectangle you want to
