...
namespace Fusion8.Cropper.Core
{
    public static class Configuration
    {
        ...
        /// <summary>
        ///     Lazily creates a single instance of the <see cref="ConfigurationPersistence" /> class so that the configuration can
        ///     be saved when the user logs off, restarts, or shuts down.
        /// </summary>
        private static ConfigurationPersistence<Settings> ConfigurationPersistence
        {
            get
        ...
        ///     <paramref name="path" /> is null; nothing
        ///     in Visual Basic.
        /// </exception>
        ...
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="settings" /> or <paramref name="path" />
