...
namespace Fusion8.Cropper.Extensibility
{
    ...
    public interface IPersistableOutput
    {
        ...
        ///     A <see cref="StreamHandler" />Delegate to the
        ///     method to call when the stream is retrieved and the image to pass to the callback.
        /// </param>
        ...
        ///         as animated gifs or video formats.
        ///     </para>
        ///     <para>
        ///         The <paramref name="imageHandler" /> parameter will be called when the screen capture
        ///         completes and should perform the necessary steps to persist the image.
        ///     </para>
        ///     <para>
        ///         Thumbnail images are not supported by this method.
        ///     </para>
        /// </remarks>
        /// <param name="imageHandler">
        ///     An <see cref="ImageHandler" /> delegate that accepts a single
        ///     <see cref="Image" /> parameter.
        /// </param>
